...
const WorkSub = () => {
  return (
    <>
      <section className=" md:flex md:justify-between items-start flex-row-reverse   ">
        <div className=" md:w-[49%] md:h-[100px]  initial-card flex items-center justify-between p-5 rounded-[12px]   ">
        ...
        <div className=" md:w-[50%] initial-card flex flex-col gap-[2rem] pb-[2rem]  justify-between md:mt-0 mt-4 p-5 rounded-[12px] ">
          <p className=" flex flex-col">
