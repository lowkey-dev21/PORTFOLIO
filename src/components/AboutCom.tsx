    ...
    <>
        ...
        <div className="md:w-[50%] flex flex-col">
          <div className="about-profile">
            <div className="profile-items md:p-[1rem]">
              ...
              <p className="info md:text-2xl md:py-[1.5rem]">
        ...
        <div className="md:w-[50%]">
          ...
          <div className="socials-container">
            <a
              ...
              href="https://github.com/lowkey-dev21"
            >
            ...
            <a
              className="initial-card social-items"
              href="https://www.instagram.com/low.key_dev"
            >
      ...
      <section className="md:gap-[2rem] md:mx-[6rem] sm:mx-[4rem] mx-[1.5rem] pb-[2rem] md:flex">
        <div className="overflow-hidden initial-card rounded-[20px] h-[150px] mb-3 flex flex-col mx-auto">
          <div className="overflow-hidden justify-center items-center mt-[1rem] w-[95%] h-[300px] mb-3 flex mx-auto">
          ...
          <p className="m-4 flex flex-col">
            <span className="text-[10px] text-slate-500">CURRENTLY USING</span>
      ...
      <section className="saturate-0 opacity-50 mx-[2rem] md:mx-[12rem]">
        ...
        <section className="md:flex md:justify-between gap-4 items-start flex-row-reverse">
          ...
          <div className="md:w-[50%] initial-card flex flex-col gap-[2rem] md:py-[3.5rem] pb-[2rem] justify-between md:mt-0 mt-4 p-5 rounded-[12px]">
            ...
            <div className="flex justify-between items-center">
              <p className="flex flex-col">
                <span className="text-[10px] text-gray-600">2024 - Present</span>
        ...
        <section className="md:flex md:mt-3 md:gap-5">
          <div className="md:w-[50%] cursor-pointer gap-3 flex flex-col justify-between initial-card p-3 mt-[1rem] md:mt-0 rounded-[10px]">
            <img
              src={oracle}
